...
import { CheckTwoTone, DirectionsBoatTwoTone } from "@mui/icons-material";
...
const PricingCard3 = () => {
  const features = [
    ...
    { text: "Resale Product", enabled: true },
        ...
        <CardContent>
          <Grid container direction={"column"} textAlign={"center"} spacing={3}>
            <Grid item textAlign={"center"}>
              ...
              >
                <DirectionsBoatTwoTone fontSize="large" color="primary" />
              </Box>
            </Grid>
            ...
            <Grid item>
              ...
              >
                You are licensed to use the CONTENT to create one end product
                for yourself or for one client (a “single application”), and may
                be sold or distributed for free.
              </Typography>
            </Grid>
            <Grid item>
